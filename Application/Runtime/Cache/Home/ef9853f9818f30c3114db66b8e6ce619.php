...
<html lang="en">
 ...
 <div class="navbar navbar-inverse navbar-fixed-top min_width" style="position:fixed;">
  ...
  <div class="container-fluid">         
    ...
    <li><a href="<?php echo U('Home/Index/app');?>" onClick="change_bg(this)" class="select">移动应用</a></li>
      ...
      <div class="row-fluid">        
        <div class="span9 right-bars" style="margin:40px;">
          <div class="row-fluid" style="z-index:1;">   
            ...
            <ul>
            <li id="one1" onClick="setTab('one',1,3)"><a href="javascript:void(0)"><img src="/Public/Img/APP_01.jpg"><p class="title">SEVENBABY电台</p></a></li>
            <li id="one2" onClick="setTab('one',2,3)"><a href="app2.html"><img src="/Public/Img/APP_02.jpg"><p class="title">意念力Leo</p></a></li>
            <li id="one3" onClick="setTab('one',3,3)"><a href="javascript:void(0)"><img src="/Public/Img/APP_03.jpg"><p class="title"><!--敬请期待 --></p></a></li>
            </ul>
            </div>
          </div><!--/row-->

          <div class="row-fluid"  id="con_one_1">         
           <div class="app-about">
           <dl>
...
宝贝用品：<br>为宝宝提供专业健康的产品。 </DIV>
                    ...
                    <div class="row-fluid"  id="con_one_2" style="display:none;">         
           <div class="app-about">
           <dl>
