...
<div class="content">
    ...
    <div class="btn-toolbar list-toolbar">
        <a class="btn btn-primary" href="<?php echo U('Admin/app/add');?>"><i class="fa fa-plus"></i>添加应用</a>
    ...
    <table class="table">
        ...
        <tbody>
        <?php if(is_array($Rs)): $k = 0; $__LIST__ = $Rs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr>
                <td><?php echo ($k); ?></td>
                ...
                <td>
                    <a href="/sb-admin.php/app/add/action/edit/id/<?php echo ($v["id"]); ?>.html"><i class="fa fa-pencil"></i></a>
                    <a href="#" onclick='del("App", "<?php echo ($v["id"]); ?>")'><i class="fa fa-trash-o"></i></a>
                </td>
